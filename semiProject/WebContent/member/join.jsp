...
<div class="row">
    <form class="col s12" action="<%=request.getContextPath()%>/member.do">
      <div class="row">
       ...
       <div class="row">
          <div class="input-field col s3">
          <input id="rpwd" type="password" class="validate">
      ...
      <button class="btn waves-effect waves-light" type="submit" name="action" style="margin-left:20px; width: 200px">가입</button>
    </form>
  </div>
